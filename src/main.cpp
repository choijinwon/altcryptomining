...
uint256 hashGenesisBlock("0x0ac2cf35e23e4255297b33ca3d56a18de47e64dc9a0b00197b7fbf01e02d64d1");
...
static const int64 nTargetTimespan = 10 * 30; // Learncoin: 5 min
static const int64 nTargetSpacing = 1 * 30; // Learncoin: 30 sec
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0ac2cf35e23e4255297b33ca3d56a18de47e64dc9a0b00197b7fbf01e02d64d1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1540002136;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1259011;
